<template>
  <div :class="this.$store.state.semidark ? 'dark' : ''">
    <div
      ...
      ${this.$store.state.isMouseHovered ? 'sidebar-hovered' : ''}
      
      `"
      @mouseenter="this.$store.state.isMouseHovered = true"
      @mouseleave="this.$store.state.isMouseHovered = false"
    >
      <div
        ...
        ${this.$store.state.isMouseHovered ? 'logo-hovered' : ''}
      ...
      >
        <router-link
          :to="{ name: 'home' }"
          v-if="
            !this.$store.state.sidebarCollasp ||
            this.$store.state.isMouseHovered
          "
        >
          <img
