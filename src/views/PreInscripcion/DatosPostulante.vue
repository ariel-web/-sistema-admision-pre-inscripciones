        ...
        <form @submit.prevent="submit">
          <div v-if="stepNumber === 0">
            <div class="grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 gap-5">
              ...
              <FormPasoUnoComponent
                v-model="form_uno"
                @valid="form_valid = $event"
              />

              <div class="mt-5 text-right col-span-3">
                <Button
                  text="Siguiente"
                  btnClass="btn-dark"
          ...
          <div v-if="stepNumber === 2">
            <div class="grid grid-cols-1 gap-5">
              ...
              <div class="mt-5 col-span-1 flex justify-between">
                <Button
                  @click.prevent="prev()"
                  text="Atras"
                  btnClass="btn-dark"
...
const submit = async () => {
  ...
  if (stepNumber.value == 2) {
    ...
    let res = await http.post("/pre-inscripcion/guardar", setFormData());
    console.log(res);
  }
  stepNumber.value++;
};
